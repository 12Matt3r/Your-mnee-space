...
const ComposerBox = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if ((!postText.trim() && !mockImage) || postText.length > maxChars || !user)
      return;
      ...
      <div className="border-b border-gray-200 dark:border-gray-800 p-4">
        <div className="text-center py-8">
          <p className="text-gray-500 dark:text-gray-400 mb-4">
            Sign in to share your creative thoughts
          </p>
          <Link
            to="/login"
    ...
    >
      <div className="flex space-x-4">
        <img
          src={
            profile?.avatar_url ||
            `https://ui-avatars.com/api/?name=${encodeURIComponent(profile?.full_name || user.email || "User")}&background=6366f1&color=fff`
          }
          alt="Your avatar"
                      ...
                      <svg className="w-full h-full transform -rotate-90">
                        ...
                        <circle
                          ...
                          strokeDashoffset={
                            ...
                            Math.PI *
                            10 *
                            (1 - Math.min(postText.length / maxChars, 1))
                          }
                          strokeLinecap="round"
