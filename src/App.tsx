...
// Default exports
const DiscordCallbackPage = lazy(() => import('./pages/auth/DiscordCallbackPage')); // Has export default
...
const PageLoader = () => (
  <div className="flex h-screen w-full items-center justify-center bg-mnee-black">
