...
const AI_SERVICES = [
  ...
  { id: 'minimax', name: 'MiniMax M2.1', costPerHour: 17, description: 'Latest multimodal AI - Coding & creative', icon: '⚡' },
  { id: 'claude', name: 'Claude', costPerHour: 27, description: 'Advanced reasoning and analysis', icon: '🧠' },
  { id: 'gpt4', name: 'GPT-4', costPerHour: 20, description: 'General purpose AI assistant', icon: '🔮' },
  { id: 'dalle', name: 'DALL-E', costPerHour: 13, description: 'Image generation', icon: '🎨' },
  { id: 'midjourney', name: 'Midjourney', costPerHour: 18, description: 'Artistic image creation', icon: '✨' },
  { id: 'whisper', name: 'Whisper', costPerHour: 8, description: 'Audio transcription', icon: '🎤' },
  { id: 'eleven', name: 'ElevenLabs', costPerHour: 15, description: 'Voice synthesis', icon: '🔊' },
];
