            ...
            <div className="flex items-center space-x-2">
              ...
              <button
                ...
                className={`p-2 rounded-lg transition-colors flex items-center gap-1 ${
                  view3D ? 'bg-purple-500/30 text-purple-300' : 'hover:bg-purple-500/20 text-gray-300 hover:text-white'
                }`}
      ...
      <div className={isFullscreen ? 'fixed inset-0 z-50' : 'h-screen pt-16'}>
        {view3D ? (
          <ArtistRoom3D 
            creator={{
              id: room.user_id,
              displayName: room.profiles?.display_name || room.profiles?.username || 'Creator',
              walletAddress: undefined,
              roomTheme: room.theme || 'neon_city',
              portfolio: [],
            }}
            onBack={() => setView3D(false)}
          />
        ) : (
